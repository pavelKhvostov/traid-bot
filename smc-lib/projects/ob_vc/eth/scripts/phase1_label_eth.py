...
Output: ~/smc-lib/projects/ob_vc/eth/data/eth_labels_2h.parquet
"""
import sys, time, pathlib
import pandas as pd, numpy as np

P_EVENTS = pathlib.Path.home() / "smc-lib/projects/ob_vc/eth/data/eth_events_e12_2023-2026.parquet"
CSV_1M = pathlib.Path.home() / "traid-bot/data/ETHUSDT_1m_vic_vadim.csv"
OUT_DIR = pathlib.Path.home() / "smc-lib/projects/ob_vc/eth/data"
OUT_DIR.mkdir(parents=True, exist_ok=True)
OUT = OUT_DIR / "eth_labels_2h.parquet"
