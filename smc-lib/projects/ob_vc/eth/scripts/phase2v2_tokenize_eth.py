...
Output: eth_features_v2.npz + eth_meta_v2.parquet
"""
import sys, time, pathlib
import pandas as pd, numpy as np

S1 = pathlib.Path.home() / "smc-lib/projects/ob_vc/eth"
LBL  = S1 / "data/eth_labels_2h.parquet"
TYPES = pathlib.Path.home() / "smc-lib/projects/ob_vc/eth/data/eth_ob_vc_24types.parquet"
EVENTS = pathlib.Path.home() / "smc-lib/projects/ob_vc/eth/data/eth_events_e12_2023-2026.parquet"
SNAP   = pathlib.Path.home() / "smc-lib/projects/ob_vc/eth/data/eth_snapshots_s7b.parquet"
CLUSTERS = pathlib.Path.home() / "smc-lib/projects/ob_vc/eth/data/eth_cluster_log_c1.parquet"
OUT_NPZ = S1 / "data/eth_features_v2.npz"
OUT_META = S1 / "data/eth_meta_v2.parquet"
