...
Output: ~/smc-lib/projects/ob_vc/eth/data/eth_features_2h.parquet
"""
import pathlib, time, sys
import pandas as pd, numpy as np

DATA = pathlib.Path.home() / "smc-lib/projects/ob_vc/eth/data"
S1_DATA = pathlib.Path.home() / "smc-lib/projects/ob_vc/eth/data"
LABELS = S1_DATA / "eth_labels_2h.parquet"
EVENTS = DATA / "eth_events_e12_2023-2026.parquet"
SNAP   = DATA / "eth_snapshots_s7b.parquet"
CLUSTERS = DATA / "eth_cluster_log_c1.parquet"
OUT    = S1_DATA / "eth_features_2h.parquet"
