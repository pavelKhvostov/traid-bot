...
EVENTS_PATH = SMC_LIB / "projects/ob_vc/eth/data/eth_events_e12_2023-2026.parquet"
CSV_PATH = pathlib.Path.home() / "traid-bot/data/ETHUSDT_1m_vic_vadim.csv"
OUT_PATH = SMC_LIB / "projects/ob_vc/eth/data/eth_snapshots_s7b.parquet"
SHARD_DIR = SMC_LIB / "projects/ob_vc/eth/data/snapshot_v7b_shards"
