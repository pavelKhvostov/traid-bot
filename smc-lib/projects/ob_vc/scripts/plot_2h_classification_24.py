...
def compute_strategy_stats():
    ...
    oos = pd.read_parquet('/home/vadim/smc-lib/projects/ob_vc/data/output4/oos_predictions.parquet')
...
total_wr = ((btc_strat_wins + eth_strat_wins) / total_sel * 100) if total_sel else 0
