...
Output: ./output/bb_obvc_1h2h_v3.parquet (~6683 rows × ~115 cols)
"""
...
OUTPUT_PARQUET = OUTPUT_DIR / "bb_obvc_1h2h_v3.parquet"
LOG_FILE = OUTPUT_DIR / "builder_v3.log"
...
def main_precompute(args):
    ...
    from smc_context_v3 import SMC_TFS
...
def process_chunk(events_chunk):
    ...
    from smc_context_v3 import extract_features
