...
Воспроизводимый pipeline для построения мнения о направлении движения цены на основе зон из `elements/`, классов зон ([[zone-class-liquidity-inefficiency-efficiency]]) и магнит-логики ([[feedback-untraded-area-is-magnet]]).
...
- **Efficiency** — OB, block_orders, ob_liq, RDRB-family
...
- НЕ путать магнит-зоны (inefficiency / liquidity) с S/R (efficiency).
...
- [[zone-class-liquidity-inefficiency-efficiency]] — таксономия для Step 4.
