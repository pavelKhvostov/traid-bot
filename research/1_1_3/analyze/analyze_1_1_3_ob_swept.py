"""SWEPT split на baseline 1.1.3 (default: fvg_variant=v1, macro_mode=untouched).
...
def main() -> None:
    print(f"[INFO] Strategy 1.1.3: SWEPT split (default: fvg_variant=v1, macro_mode=untouched)")
    print()
    ...
    out = Path("signals/analyze_1_1_3_ob_swept_summary.txt")
    out.parent.mkdir(parents=True, exist_ok=True)
    with out.open("w", encoding="utf-8") as f:
        f.write(f"1.1.3 SWEPT split summary (fvg_variant=v1, macro_mode=untouched)\n")
