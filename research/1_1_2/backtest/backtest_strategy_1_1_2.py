"""Бэктест Strategy 1.1.2 на BTCUSDT.

1.1.2 = 1.1.1 с заменой macro FVG-4h/6h на macro OB-4h/6h.
Симуляция: limit-вход = середина FVG-15m/20m. SL = OB_SL_DEPTH inside top-OB.
RR=1.0 и RR=2.2.
"""
...
SYMBOL = "BTCUSDT"
RR_RUNS = [
    (1.0, Path("signals/strategy_1_1_2_3y_RR1.csv")),
    (2.2, Path("signals/strategy_1_1_2_3y_RR2.2.csv")),
]
...
def main():
    ...
    print(f"[INFO] Strategy 1.1.2 backtest, {SYMBOL}, окно {DAYS_BACK}d, RR={rrs}")
    print()
    ...
    signals = detect_strategy_1_1_2_signals(
        df_1d_f, df_12h_f, df_4h, df_6h, df_1h, df_2h, df_15m, df_20m, verbose=True,
    )
