"""SWEPT split на baseline 1.1.4 (default: fvg_variant=v1).
...
def main() -> None:
    print(f"[INFO] Strategy 1.1.4: SWEPT split (default: fvg_variant=v1)")
    print()
    ...
    out = Path("signals/analyze_1_1_4_ob_swept_summary.txt")
    out.parent.mkdir(parents=True, exist_ok=True)
    with out.open("w", encoding="utf-8") as f:
        f.write(f"1.1.4 SWEPT split summary (fvg_variant=v1)\n")
